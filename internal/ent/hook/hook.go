...
// The IPRuleFunc type is an adapter to allow the use of ordinary
// function as IPRule mutator.
type IPRuleFunc func(context.Context, *ent.IPRuleMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f IPRuleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.IPRuleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.IPRuleMutation", m)
}
...
// The OAuthRedirectURIFunc type is an adapter to allow the use of ordinary
// function as OAuthRedirectURI mutator.
type OAuthRedirectURIFunc func(context.Context, *ent.OAuthRedirectURIMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OAuthRedirectURIFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OAuthRedirectURIMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OAuthRedirectURIMutation", m)
}
