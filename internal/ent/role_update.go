...
func (_u *RoleUpdate) AddUsers(v ...*UserRole) *RoleUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearUsers clears all "users" edges to the UserRole entity.
func (_u *RoleUpdate) ClearUsers() *RoleUpdate {
	_u.mutation.ClearUsers()
	return _u
}

// RemoveUserIDs removes the "users" edge to UserRole entities by IDs.
func (_u *RoleUpdate) RemoveUserIDs(ids ...uuid.UUID) *RoleUpdate {
	_u.mutation.RemoveUserIDs(ids...)
	return _u
}

// RemoveUsers removes "users" edges to UserRole entities.
func (_u *RoleUpdate) RemoveUsers(v ...*UserRole) *RoleUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *RoleUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.OrganizationIDCleared() {
		_spec.ClearField(role.FieldOrganizationID, field.TypeUUID)
	}
...
// AddUsers adds the "users" edges to the UserRole entity.
func (_u *RoleUpdateOne) AddUsers(v ...*UserRole) *RoleUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveUsers removes "users" edges to UserRole entities.
func (_u *RoleUpdateOne) RemoveUsers(v ...*UserRole) *RoleUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
