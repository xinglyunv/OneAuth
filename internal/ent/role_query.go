...
func (_q *RoleQuery) QueryUsers() *UserRoleQuery {
...
func (_q *RoleQuery) WithUsers(opts ...func(*UserRoleQuery)) *RoleQuery {
	query := (&UserRoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withUsers; query != nil {
		if err := _q.loadUsers(ctx, query, nodes,
			func(n *Role) { n.Edges.Users = []*UserRole{} },
			func(n *Role, e *UserRole) { n.Edges.Users = append(n.Edges.Users, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RoleQuery) loadUsers(ctx context.Context, query *UserRoleQuery, nodes []*Role, init func(*Role), assign func(*Role, *UserRole)) error {
