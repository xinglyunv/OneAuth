...
func (*Organization) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case organization.FieldName, organization.FieldSlug, organization.FieldDescription, organization.FieldDomain, organization.FieldLogoURL, organization.FieldStatus:
